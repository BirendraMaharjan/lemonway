...
class Templates extends Base {
	...
	public function get( $slug, $name = null, $args = array(), $load = true ): string {
		...
		do_action( 'lemonway_get_template_part_' . $slug, $slug, $name, $args );
	...
	protected function getFileNames( $slug, $name, $args ): array {
		 ...
		 * @since 1.0.0
		 */
		return apply_filters( 'lemonway_get_template_part', $templates, $slug, $name, $args );
	}
	...
	protected function getPaths(): array {
		 ...
		 * @since 1.0.0
		 */
		$file_paths = apply_filters( 'lemonway_template_paths', $file_paths );
