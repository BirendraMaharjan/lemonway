...
$linked_iban         = $lemonway_dokan->iban->isLinkedIban( $lemonway_account_id );
...
<div id="lemonway-link-bank-section">
	...
	<?php
	$data = $lemonway_dokan->lemonway_api->apiErrorMessage();
	if ( $data ) {
	...
	<div id="lemonway-link-bank" class="<?php echo $linked_iban ? 'hide' : ''; ?>">
